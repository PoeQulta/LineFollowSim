class robotView
{
    constructor(initPose={x:app.screen.width / 2,y:app.screen.height / 2})
    {
        ...
        texturepromise.then((resolved) =>
            ...
            const sensorViewPos = {x:this.sprite.x+this.sensor.localPose.x-this.sensor.size/2,
                y:this.sprite.y+this.sensor.localPose.y-this.sensor.size/2
            }
...
var testPath = "M 50 300 C 100 225 150 50 250 150 C 300 200 150 450 350 450 C 350 275 400 300 400 100 C 400 50 500 150 550 50 C 550 50 550 550 600 350 A 50 50 0 1 1 650 550";  
var robo = null
var env = new Environment(testPath,(env)=>
    {
        const graphics = new PIXI.Graphics().svg(env.svg);
